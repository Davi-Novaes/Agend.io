        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center gap-3 py-10 text-center">
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground text-sm">Voce ainda nao possui atendimentos agendados.</p>
            </div>
          ...
          <ul className="flex flex-col divide-y">
            {appointments.map((appointment) => (
              <li
                key={appointment.id}
                className="hover:bg-accent/40 -mx-2 flex items-center gap-3 rounded-lg px-2 py-3 transition-colors first:pt-0 last:pb-0"
              >
                <span
                  aria-hidden="true"
