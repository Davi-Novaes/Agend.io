...
// bg/15+text: tinta so o badge do icone, nunca o card inteiro. shadow-[...]:
// glow bem pequeno na cor da categoria (Faturamento=roxo, Despesas=vermelho,
// Resultado=verde, Agendamentos=azul) -- o "detalhe sutil" pedido, sem virar
// um card colorido.
...
export function MetricCard({
  ...
  return (
    <Card
      size="sm"
      className={cn(
        "border border-border/70 ring-0 shadow-none transition-colors duration-200 hover:bg-card-hover",
        featured && "bg-primary/[0.05] hover:bg-primary/[0.08]"
      )}
    >
