...
public class ProductTests
{
    ...
    {
        var result = Product.Create(Tenant, "   ", null, null, 10, 2, null);
    ...
    {
        var result = Product.Create(Tenant, "Xampu", null, null, -1, 2, null);
    ...
    {
        var result = Product.Create(Tenant, "Xampu", null, null, 10, -1, null);
    ...
    {
        var result = Product.Create(Tenant, "Xampu", "SKU-1", "Xampu revenda", 10, 2, Money.Create(29.9m).Value);
    ...
    {
        var product = Product.Create(Tenant, "Xampu", null, null, 10, 2, null).Value;

        var result = product.Update("Xampu 500ml", "SKU-2", "Atualizado", 5, null);
    ...
    public void Update_Should_Fail_When_Name_Is_Empty()
    {
        ...
        var result = product.Update("  ", null, null, 2, null);
