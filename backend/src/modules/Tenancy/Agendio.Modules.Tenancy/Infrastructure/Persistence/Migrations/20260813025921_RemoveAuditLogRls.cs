    ...
    public partial class RemoveAuditLogRls : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                DROP POLICY tenant_isolation ON tenancy.audit_log;
                ALTER TABLE tenancy.audit_log DISABLE ROW LEVEL SECURITY;
                """);
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                ...
                CREATE POLICY tenant_isolation ON tenancy.audit_log
