...
namespace Agendio.Modules.Platform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260822004548_AddPlatformMfaAndSecurityHardening")]
    partial class AddPlatformMfaAndSecurityHardening
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Agendio.Infrastructure.Persistence.SecurityAuditLogEntry", b =>
                {
                    ...
                    b.ToTable("security_audit_log", "platform");
                });

            modelBuilder.Entity("Agendio.Modules.Platform.Domain.PlatformAdmin", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
