    ...
    public partial class RemoveAuditLogRls : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                DROP POLICY tenant_isolation ON resources.audit_log;
                ALTER TABLE resources.audit_log DISABLE ROW LEVEL SECURITY;
                """);
        }
        ...
        {
            migrationBuilder.Sql("""
                ALTER TABLE resources.audit_log ENABLE ROW LEVEL SECURITY;
                CREATE POLICY tenant_isolation ON resources.audit_log
